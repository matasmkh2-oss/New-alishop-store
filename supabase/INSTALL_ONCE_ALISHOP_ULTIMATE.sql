...
-- ===== Ultimate V13 stability additions =====
-- =========================================================
-- AliShop Ultimate V13 — Safe Stability Migration
-- شغّل مرة واحدة بعد V12
-- لا يحذف المستخدمين أو الأرصدة أو الطلبات
-- =========================================================
...
values(
  '13.0.0',
  'Ultimate V13 stability: restored category administration and admin registry validation'
)
on conflict(version) do update set
  installed_at=now(),
  notes=excluded.notes;
